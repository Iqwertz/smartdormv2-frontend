...
export const TenantBudgetPage = React.lazy(() => import("./pages/tenants/BudgetPage"));
export const FinanceManagementPage = React.lazy(() => import("./pages/engagements/FinanceManagementPage"));
